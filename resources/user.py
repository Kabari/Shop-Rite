...
class UserLogin(MethodView):
    ...
    def post(self, user_data):
        ...
        if user and pbkdf2_sha256.verify(user_data["password"], user.password):
            access_token = create_access_token(identity=user.id, freah=True)
...
class TokenRefresh(MethodView):
    ...
    def post(self):
        ...
        new_token = create_access_token(identity=current_user, fresh=False, expires_delta=timedelta(days=5))
